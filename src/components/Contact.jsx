  ...
  return (
    <div className="min-h-screen">
      <div className="flex flex-col">
        ...
        <section className=" ">
          <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md border-2 rounded-md border-black">
            <p className="mb-8 lg:mb-16 text-center text-gray-500 dark:text-gray-400 sm:text-2xl">
